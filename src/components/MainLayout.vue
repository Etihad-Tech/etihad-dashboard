  ...
  <div class="min-h-screen bg-gray-50 text-gray-900">
    ...
    >
      <div class="px-5 py-5 flex items-center gap-3">
        ...
        <h1 class="text-lg font-bold text-gray-900 tracking-tight">Etihad Dashboard</h1>
      </div>
    ...
    <div class="sticky top-0 z-30 flex items-center justify-between bg-white border-b border-gray-200 px-4 py-3 lg:hidden">
      <div class="flex items-center gap-3">
        ...
        <span class="text-sm font-bold text-gray-900">Etihad Dashboard</span>
      </div>
      <button
      ...
      >
        ...
        <span class="absolute w-5 h-0.5 bg-current rounded-full transition-all duration-300" :class="sidebarOpen ? 'opacity-0 scale-0' : 'opacity-100'"></span>
        <span class="absolute w-5 h-0.5 bg-current rounded-full transition-all duration-300" :class="sidebarOpen ? '-rotate-45' : 'translate-y-1.5'"></span>
      </button>
    </div>
