  ...
  <div class="min-h-screen bg-gray-50 text-gray-900">
    ...
    >
      <div class="px-5 py-5 flex items-center gap-3">
        ...
        <h1 class="text-lg font-bold text-gray-900 tracking-tight">Etihad Jamoasi</h1>
      </div>
    ...
    <div class="sticky top-0 z-30 flex items-center justify-between bg-white border-b border-gray-200 px-4 py-3 lg:hidden">
      <div class="flex items-center gap-3">
        ...
        <span class="text-sm font-bold text-gray-900">Etihad Jamoasi</span>
      </div>
      <button
...
const mainNav = [
  { to: '/team', label: 'Dashboard', icon: 'chart-line' },
  { to: '/team/trips', label: 'Safarlar', icon: 'plane' },
]

const supportNav = [
  { to: '/team/templates', label: 'Shablonlar', icon: 'file-lines' },
  { to: '/team/polls', label: "So'rovnomalar", icon: 'chart-pie' },
  { to: '/team/export', label: 'Export', icon: 'file-export' },
]
