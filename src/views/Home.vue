    ...
    <div class="space-y-6">
      <div class="flex items-center justify-between animate-fade-up">
        ...
        <button
          ...
          class="flex items-center gap-2 px-3 py-1.5 text-sm text-gray-500 hover:text-gray-700 hover:bg-gray-100 rounded-xl transition-colors"
        >
      ...
      <div v-else class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
        ...
        >
          ...
          <div v-else class="mb-4 px-3 py-2 bg-gray-50 rounded-xl">
          ...
          <button
            ...
            disabled
            class="w-full py-2.5 text-sm font-medium rounded-xl bg-emerald-50 text-emerald-600 border border-emerald-200"
          >
